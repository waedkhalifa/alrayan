...
<div id="wrapper">
    ...
    <nav class="navbar-default navbar-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav" id="main-menu">
                ...
                <li>
                    <a  class="active-menu" href="chart.php"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-graph-up" viewBox="0 0 16 16">
    ...
    <div id="page-wrapper">
        ...
        <div id="page-inner">
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        Earnings Chart  <small>(Yearly report) </small>
                    </h1>
                </div>
            </div>
            ...
            $query = "SELECT SUM(Allcost) AS sum, YEAR(checkout) AS year FROM pay group by year order by year desc";
...
<script>
    ...
    var chart = new Chart(ctx, {
        ...
        options: {
            ...
            title: {
                display: true,
                text: 'Report For Yearly Earnings of Al-Rayan Hotel (Dollars)'
            }
        }
    });
